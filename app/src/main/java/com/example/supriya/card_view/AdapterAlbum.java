 ...
 */
public class AdapterAlbum extends RecyclerView.Adapter<AdapterAlbum.ViewHolderInner>{
    ...
    public AdapterAlbum(Context context, List<Album> albumList) {
    ...
    public void onBindViewHolder(final ViewHolderInner holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(),Songs_List.class);
               // intent.setClass(view.getContext(),Songs_List.class);
